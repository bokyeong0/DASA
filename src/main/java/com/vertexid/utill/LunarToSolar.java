...
public class LunarToSolar {
    private static String[] solarArr = new String[]{"0101", "0301", "0505", "0606", "0815", "1003", "1225"};
    ...
    public static void main(String[] args) {
        System.out.println("20181003        : " + LunarToSolar.isHoliday("20181003"));     
        
//        System.out.println("20150218 (음력) : " + LunarToSolar.isHoliday("20150218")); // 설날 - 전날
//        System.out.println("20150219 (음력) : " + LunarToSolar.isHoliday("20150219")); // 설날       
//        System.out.println("20150220 (음력) : " + LunarToSolar.isHoliday("20150220")); // 설날 - 다음날
//        System.out.println("20170130        : " + LunarToSolar.isHoliday("20170130"));       
//        System.out.println("20151225 (양력) : " + LunarToSolar.isHoliday("20151225")); // 크리스마스
//        System.out.println("20151226        : " + LunarToSolar.isHoliday("20151226"));
//        System.out.println("20150929 (대체) : " + LunarToSolar.isHoliday("20150929")); // 대체 휴일
    }   
}