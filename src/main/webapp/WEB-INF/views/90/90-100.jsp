...
<html>
<head>
<script type="text/javascript" src="<%=jsPath%>/routine/90/90-100.js"></script>
...
<article class="content">
	<!-- 레이어 팝업 시작 -->
	<div id="tempPop90100" style="display: none ;">
		<div class="popup" style="width: 800px;">
			<div class="phead">
				<span id="">학생 수정</span>
				<a id="tempPopCloseX90100" class="phead-closex">닫기</a>
			</div>
			<div class="con">
				<div class="tbl_tab">
					<ul>
			...
			<div class="pfooter">
				...
				<button type="button" class="white" id="tempClose90100">
					닫기
				</button>
			</div>
		</div>
	...
	<section>
		<div class="searchbox">
			...
			<div class="btn_gup">
				...
				<button class="skyblue" id="tempOpen90100" >결재상신</button>
			</div>
		</div>
	</section>
	<section>
