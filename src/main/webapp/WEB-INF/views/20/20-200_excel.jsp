 						...
 						<c:choose>		
							...
							<c:otherwise>
								<th scope="col" style="text-align:center;">					
						     	<c:choose>
							    	<c:when test="${week eq 1}">ÀÏ</c:when>
							    	<c:when test="${week eq 2}">¿ù</c:when>
							    	<c:when test="${week eq 3}">È­</c:when>
							    	<c:when test="${week eq 4}">¼ö</c:when>
							    	<c:when test="${week eq 5}">¸ñ</c:when>
							    	<c:when test="${week eq 6}">±İ</c:when>
							    	<c:when test="${week eq 7}">Åä</c:when>
							    </c:choose>
								</th>
							</c:otherwise>
						</c:choose>
