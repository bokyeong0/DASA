...
(function($) {
    ...
    $.fn.postcodify = function(options) {
        ...
        return this.each(function() {
            ...
            var etTitle = $('<strong>검색 키워드</strong>').appendTo(controls);
            ...
            var searchButton = $('<button type="button" class="red"><i>검색</i></button>').attr("id", uniqueId + "_button").html(settings.searchButtonContent).appendTo(controls);
